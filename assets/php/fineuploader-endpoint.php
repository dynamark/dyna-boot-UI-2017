...
require_once "fineuploader-handler.php";
...
//    $result = $uploader->handleUpload("../../files");
    ...
    // set permissions to allow write/delete
	$uploadName = $uploader->getUploadName();
	chmod($folder.'/'.$uploadName,0766);
	// return name and folder for the callback handler
    $result["uploadName"] = $uploadName;
    $result["uploadFolder"] = $folder;

...
class UploadHandler {
    ...
    public function handleUpload($uploadDirectory, $name = null){
        ...
        if ($this->toBytes(ini_get('post_max_size')) < $this->sizeLimit ||
            ...
            return array('error'=>"Server error. Increase php.ini post_max_size and upload_max_filesize to ".$size);
        }
        ...
        if ($folderInaccessible){
            return array('error' => "Server error. Uploads directory $uploadDirectory isn't writable" . ((!$isWin) ? " or executable." : "."));
        }
